#ifndef __RTR_HELPERS_H_
#define __RTR_HELPERS_H_
#include <cstdint>
...
{
public:
	static ComPtr<ID3DBlob> ShaderCompile(const std::wstring& filename, const D3D_SHADER_MACRO* defines, const std::string& entrypoint, const std::string& target)
	{
		UINT compileFlags = 0;
